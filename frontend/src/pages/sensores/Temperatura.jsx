...
export default function Temperatura() {
  ...
  useEffect(() => {
    api.get('api/sensores/?sensor=TEMPERATURA').then(r => setSens(r.data)).catch(() => {});
    api.get('api/historicos/?sensor__sensor=TEMPERATURA')
    ...
    <Layout>
      <div style={{ padding: '2rem' }}>
        ...
        <p style={{ color: 'var(--muted)', fontSize: 13, marginBottom: '1.5rem' }}>
          Histórico de leituras — unidade: °C
        </p>
        ...
        <div style={{
          ...
          <Table
            columns={['ID', 'Sensor', 'Valor (°C)', 'Timestamp']}
            rows={dados}
